...
export const CollectionPopup = ({ collection }: { collection: string }) => {
    ...
    return (
        <div
            className='fixed top-2/4 left-2/4 w-screen h-screen bg-transparent flex justify-center items-center'
            style={{ transform: "translate(-50%, -50%)" }}
            data-testid="popup-wrapper"
        >
            <div
                className="bg-[#10141f] w-4/5 h-4/5 p-5 shadow-lg rounded-lg overflow-y-auto"
                data-testid="popup"
                ref={containerRef}
            >
                <div className="bg-[#10141f] w-full flex justify-end">
                ...
                <div className='flex justify-center'>
                    <button 
                        className='rounded-lg p-3 bg-black w-[50%] font-semibold text-white mt-3 p-4'
                        {...!isLoading && {
